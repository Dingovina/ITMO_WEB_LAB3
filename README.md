# Лабораторная работа по теме "Разработка веб-приложений на языке Java"
...
- Интерактивный элемент, содержащий изображение области на координатной плоскости (в соответствии с вариантом задания) и реализующий следующую функциональность:
  ...
  - После проверки факта попадания точки в область изображение должно быть обновлено с учетом результатов этой проверки (т.е., на нем должна появиться новая точка).
